 ...
 * Uses in-memory storage as fallback. Replace with EncryptedSharedPreferences in production.
 */
actual object SecureStorageFactory {
    actual suspend fun create(): Result<SecureStorage> = Result.success(InMemorySecureStorage())
